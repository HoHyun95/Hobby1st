...
<body>
	<form method="post" onsubmit="return confirm('정말 수정하시겠습니까?')"
		action="/qna/updateQna?qna_seq=${detail.qna_seq }&cpage=${cpage }&check_num=${check_num }&keyword=${keyword }&searchWord=${searchWord }">
		<!-- 글쓰기 Header -->
		<div style="padding-top: 40px;" class="container con22">
			...
			<div>
				...
				<!-- textarea 태그에 작성 -->
				<div>
					<textarea name="qna_contents" id="summernote">${detail.qna_contents }</textarea>
				</div>
