...
<script>
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function(arg){
        	...
        	window.open("/calendar/calendarDetail?title="+arg.event.title+"&end="+arg.event.end+"&start="+arg.event.start+"&club_cl_name=${club_cl_name}","PopupWin","toolbar=no,scrollbars=no,resizable=no,top=500,left=500,width=400,height=400");
