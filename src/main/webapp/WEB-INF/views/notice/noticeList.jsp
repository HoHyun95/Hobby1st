						...
						<c:forEach var="dto" items="${noticeList }" varStatus="status">
							<tr
								...
								<td class="title px-4 py-4" style="cursor: pointer;"
									onclick="location.href='/notice/noticeDetail?notice_seq=${dto.notice_seq }&check_num=${check_num }&cpage=${cpage }&keyword=${keyword }&searchWord=${searchWord}'">
									${dto.notice_title }</td>
								<td class="px-4 py-4 text-center">관리자</td>
								<td class="px-4 py-4 text-center">${dto.formDate }</td>
								<td class="px-4 py-4 text-center">${dto.notice_view_count }</td>
